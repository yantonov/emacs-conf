...
#  Download dist в /opt/clojure/dist/jline-xxx
cd /opt/clojure/jar
...
echo ";; clojure-mode" >> ~/emacs/init.el
echo "(load \"~/emacs/rc/emacs-rc-clojure.el\")" >> init.el
#
#
# 11. slime
...
echo ";; slime" >> init.el
echo "(load \"~/emacs/rc/emacs-rc-slime.el\")" >> init.el
#
#
# 12. leiningen
cd /opt/clojure/sh
